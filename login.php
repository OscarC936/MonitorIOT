...
if(isset($_POST['email']) && isset($_POST['password'])) {
  ...
  //  $password= sha1(strip_tags($_POST['password']));
    ...
    if ($count == 1){
      ...
      $msg .= "Exito!!!";
      $_SESSION['logged'] = true; // logeo exitoso
      echo '<meta http-equiv="refresh" content="2; url=devices.php">'; // logeo exitoso entonces se abre el dashboard
...
<!-- ############ LAYOUT START-->
  <div class="center-block w-xxl w-auto-xs p-y-md">
    <div class="navbar">
      ...
      <div class="p-v-lw text-center">
       <div ui-include="'assets/images/logo.svg'"> </div>  <h3>VMScloud</h3>
      </div>
      </div>
    </div>
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      ...
      <form target="" method="post" name="form">
        ...
        <button type="submit" class="btn primary btn-block p-x-md">Inicie sesión</button>
      </form>
    ...
    <div class="p-v-lg text-center">
      <div class="m-b"><a ui-sref="access.forgot-password" href="forgot-password.html" class="text-primary _600">Olvido su contraseña?</a></div>
