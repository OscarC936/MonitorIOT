              ...
              <div class="box p-a">
                <div class="pull-left m-r">
                  <span class="w-48 rounded  accent">
                     <img width="35" height="35" src="https://cdn-icons.flaticon.com/png/512/3877/premium/3877444.png?token=exp=1641428984~hmac=bf0da231e5198867c80a996d756fbf6f" alt="`tipo de sangre o icono gratis" title="`tipo de sangre o icono gratis" class="loaded">
                  </span>
                </div>
                <div class="clear">
                  <h4 class="m-0 text-lg _300"><b id="display_temp1">-- </b><span class="text-sm"> %</span></h4>
                  <small class="text-muted">SpO2: 98 %</small>
                </div>
              </div>
            </div>
            <div class="col-xs-6 col-sm-4">
              <div class="box p-a">
                ...
                <div class="clear">
                  ...
                  <small class="text-muted">Temp Corporal: 38 °C</small>
                </div>
              </div>
            </div>
            <div class="col-xs-6 col-sm-4">
              <div class="box p-a">
                ...
                <div class="clear">
                  <h4 class="m-0 text-lg _300"><b id="display_volt">-- </b><span class="text-sm"> BPM</span></h4>
                  <small class="text-muted">Pulso Cardiaco: 86 BPM</small>
                </div>
              </div>
            </div>
          </div>
...
const WebSocket_URL = 'wss://vmscloud.com.ar/:8094/mqtt'
